  ...
  return (
    <>
      ...
      <Section>
        ...
        {/* Excel Import Card */}
        {!isReadOnly && (
          <div className="mb-6 p-4 rounded-xl border bg-gradient-to-r from-amber-50/50 via-white to-orange-50/30 shadow-sm" style={{ borderColor: "#FED7AA" }}>
            <div className="flex flex-wrap items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-lg flex items-center justify-center bg-emerald-100 text-emerald-800 font-bold shrink-0">
              ...
              <div className="flex flex-wrap items-center gap-2.5">
                <button
                  ...
                  className="flex items-center gap-1.5 px-3.5 py-1.5 text-xs font-bold rounded-lg border bg-emerald-50 text-emerald-800 border-emerald-200 hover:bg-emerald-100 transition shadow-xs"
                >
                ...
                {excelFile && (
                  <button
                    ...
                    disabled={importing}
                    className="flex items-center gap-1.5 px-4 py-1.5 text-xs font-semibold rounded-lg text-white transition shadow-sm bg-emerald-600 hover:bg-emerald-700 disabled:opacity-50"
                  >
                    {importing ? (
        ...
        {errors?._global && (
          <div className="mb-5 px-4 py-3 rounded-lg border text-sm font-semibold flex items-center gap-2.5 shadow-sm" style={{ borderColor: "#fca5a5", backgroundColor: "#fef2f2", color: "#991b1b" }}>
